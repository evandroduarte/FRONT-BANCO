...
import { FiMapPin, FiUser, FiImage, FiDollarSign, FiPlus } from 'react-icons/fi';
        ...
        <Fundo>
            ...
            <Content>
                <Header>
                    ...
                    <div className="info">
                        <FiPlus size={16} color="#463B88" />
                        <Link className="link" to ="/registercausa">Cadastrar causa</Link>
